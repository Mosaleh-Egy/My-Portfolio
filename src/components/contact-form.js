...
function ContactForm() {
  ...
  function sendEmail(e) {
      ...
      .then(function(response) {
        ...
        setFormMessage("Your message couldn't be sent. Please email Mohammad directly at mohammadahmed@gmail.com");
      });
  }
  ...
  return (
    <Form onSubmit={sendEmail} id="contactForm">
      <Form.Group controlId="name">
        ...
        <Form.Control required name="name" placeholder="Jhon Wick" onBlur={handleChange} />
      </Form.Group>

      <Form.Group controlId="email">
        <Form.Label>Your Email</Form.Label>
        <Form.Control required name="email" type="email" placeholder="Jhonw@gmail.com"  onBlur={handleChange} />
      </Form.Group>
